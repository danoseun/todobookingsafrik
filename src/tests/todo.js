...
import {realTodo, realTodoTwo, fakeTodo, noNameTodo, realTodoOne} from './testdata'
...
describe('Testing the booking endpoints:', () => {
  it('It should create a todo', (done) => {
    chai.request(app)
      ...
      .end((err, res) => {
        ...
        console.log('rES1', res.body.data);
  ...
  it('It should not create a todo with incomplete parameters', (done) => {
    chai.request(app)
      .post('/api/v1/todos')
      .set('Accept', 'application/json')
      .send(fakeTodo)
